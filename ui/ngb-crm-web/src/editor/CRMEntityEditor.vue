...
const partErrors = computed<CRMDocumentPartErrors>(() => {
  const result: CRMDocumentPartErrors = {}
...
const persistenceContext: CRMEntityEditorPersistenceContext = {
  kind: editorKind,
  typeCode: editorTypeCode,
  mode: editorMode,
...
const afterFormExtensions = computed<EntityEditorRenderExtension[]>(() => {
  ...
  return [{
    key: 'crm-document-parts',
    component: CRMDocumentPartsEditor,
    props: {
      ...
      behavior: crmMetadataFormBehavior,
