...
export default defineConfig({
  ...
  webServer: {
    command: `npm --workspace ngb-trade-web run dev -- --host ${e2eHost} --port ${e2ePort} --strictPort --mode e2e`,
    port: e2ePort,
