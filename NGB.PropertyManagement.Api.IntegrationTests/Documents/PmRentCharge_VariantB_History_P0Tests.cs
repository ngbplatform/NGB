...
public sealed class PmRentCharge_VariantB_History_P0Tests : IAsyncLifetime
{
    private readonly PmIntegrationFixture _fixture;

    public PmRentCharge_VariantB_History_P0Tests(PmIntegrationFixture fixture) => _fixture = fixture;
        ...
        try
        {
            ...
            var documentHistory = await uow.Connection.QuerySingleAsync<int>(
                new CommandDefinition(
                    ...
                    new { document_id = seeded.RentCharge.Id },
...
""";
            ...
            var accountingRows = (await uow.Connection.QueryAsync<AccountingEntryRow>(
                new CommandDefinition(accountingSql, new { document_id = seeded.RentCharge.Id }, uow.Transaction, cancellationToken: CancellationToken.None)))
                .AsList();
