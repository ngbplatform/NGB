...
public sealed class PmDocumentSchemaValidation_NoRepair_P0Tests(PmIntegrationFixture fixture)
{
    [Fact]
    public async Task DocumentSchemaValidation_AfterCleanMigrate_WithoutRepair_Passes()
    {
        await using var db = await TemporaryDatabase.CreateAsync(fixture.ConnectionString, "ngb_pm_document_schema");
