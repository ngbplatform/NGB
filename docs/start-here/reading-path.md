---
title: Reading path
description: Recommended reading routes through the NGB documentation site for onboarding, architecture study, and implementation work.
---
...
2. [Repository Structure](/start-here/repository-structure)
3. [Run Locally](/start-here/run-locally)
4. [Manual local runbook](/start-here/manual-local-runbook)
5. [Host composition](/start-here/host-composition)
6. [Architecture Overview](/architecture/overview)
7. [Layering and Dependencies](/architecture/layering-and-dependencies)
8. [Documentation Map](/reference/documentation-map)

## If you need execution flow next
...
## If you need subsystem depth next
...
## If you are extending the platform
...
## If you need concrete scenario examples
...
- [Guide · Add Canonical and Composable Reports](/guides/reports/canonical-and-composable)

## If you need source-tracing pages
