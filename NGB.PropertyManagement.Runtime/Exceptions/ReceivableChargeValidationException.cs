...
public sealed class ReceivableChargeValidationException(
    string message,
    string errorCode,
    IReadOnlyDictionary<string, object?>? context = null)
    : NgbValidationException(message, errorCode, context)
{
    public static ReceivableChargeValidationException LeaseNotFound(Guid leaseId, Guid? documentId = null)
        => new(
    ...
    public static ReceivableChargeValidationException LeaseMarkedForDeletion(Guid leaseId, Guid? documentId = null)
        => new(
    ...
    public static ReceivableChargeValidationException ChargeTypeNotFound(Guid chargeTypeId, Guid? documentId = null)
        => new(
            message: "Selected charge type was not found.",
            errorCode: "pm.validation.receivable_charge.charge_type_not_found",
            context: BuildContext(
                documentId: documentId,
    ...
    public static ReceivableChargeValidationException ChargeTypeMarkedForDeletion(
        Guid chargeTypeId,
        Guid? documentId = null)
        => new(
            message: "Selected charge type is marked for deletion.",
            errorCode: "pm.validation.receivable_charge.charge_type_deleted",
            context: BuildContext(
                documentId: documentId,
                chargeTypeId: chargeTypeId,
                errors: new Dictionary<string, string[]>(StringComparer.Ordinal)
    ...
    public static ReceivableChargeValidationException AmountMustBePositive(decimal amount, Guid? documentId = null)
        => new(
            message: "Amount must be positive.",
            errorCode: "pm.validation.receivable_charge.amount_must_be_positive",
            context: BuildContext(
                documentId: documentId,
                amount: amount,
                errors: new Dictionary<string, string[]>(StringComparer.Ordinal)
    ...
    public static ReceivableChargeValidationException PartyMismatch(
        Guid leaseId,
    ...
    public static ReceivableChargeValidationException PropertyMismatch(
        Guid leaseId,
