...
public sealed class LateFeeChargeValidationException(
    string message,
    string errorCode,
    IReadOnlyDictionary<string, object?>? context = null)
    : NgbValidationException(message, errorCode, context)
{
    public static LateFeeChargeValidationException LeaseNotFound(Guid leaseId, Guid? documentId = null)
        => new(
            message: "Selected lease was not found.",
            errorCode: "pm.validation.late_fee_charge.lease_not_found",
    ...
    public static LateFeeChargeValidationException LeaseMarkedForDeletion(Guid leaseId, Guid? documentId = null)
        => new(
            message: "Selected lease is marked for deletion.",
            errorCode: "pm.validation.late_fee_charge.lease_deleted",
            context: BuildContext(
                documentId: documentId,
                leaseId: leaseId,
                errors: new Dictionary<string, string[]>(StringComparer.Ordinal)
    ...
    public static LateFeeChargeValidationException AmountMustBePositive(decimal amount, Guid? documentId = null)
        => new(
            message: "Amount must be positive.",
            errorCode: "pm.validation.late_fee_charge.amount_must_be_positive",
            context: BuildContext(
                documentId: documentId,
                amount: amount,
                errors: new Dictionary<string, string[]>(StringComparer.Ordinal)
    ...
    public static LateFeeChargeValidationException PartyMismatch(
        Guid leaseId,
        ...
        => new(
            ...
            errorCode: "pm.validation.late_fee_charge.lease_party_mismatch",
            context: BuildContext(
                documentId: documentId,
                leaseId: leaseId,
    ...
    public static LateFeeChargeValidationException PropertyMismatch(
        Guid leaseId,
        ...
        => new(
            ...
            errorCode: "pm.validation.late_fee_charge.lease_property_mismatch",
            context: BuildContext(
                documentId: documentId,
                leaseId: leaseId,
