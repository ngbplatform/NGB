...
/// <summary>
/// Draft-time invariant for pm.late_fee_charge:
/// property_id must reference an existing, non-deleted pm.property of kind=Unit.
/// </summary>
internal sealed class LateFeeChargePropertyMustBeUnitPayloadValidator(IPropertyManagementDocumentReaders readers)
    : IDocumentDraftPayloadValidator
{
    public string TypeCode => PropertyManagementCodes.LateFeeCharge;

    public Task ValidateCreateDraftPayloadAsync(
