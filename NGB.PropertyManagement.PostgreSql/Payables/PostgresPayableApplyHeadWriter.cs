...
public sealed class PostgresPayableApplyHeadWriter(IUnitOfWork uow) : IPayableApplyHeadBatchWriter
{
...
""";
    ...
    public async Task UpsertManyAsync(IReadOnlyList<PayableApplyHeadWrite> items, CancellationToken ct = default)
    {
