...
/// <summary>
/// Immutable technical history for recorder-scoped reference register write attempts.
/// </summary>
public sealed class ReferenceRegisterWriteLogHistoryMigration : IDdlObject
{
    public string Name => "reference_register_write_log_history";
