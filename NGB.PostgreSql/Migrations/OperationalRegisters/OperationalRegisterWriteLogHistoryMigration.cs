...
/// <summary>
/// Immutable technical history for operational register write attempts.
/// </summary>
public sealed class OperationalRegisterWriteLogHistoryMigration : IDdlObject
{
    public string Name => "operational_register_write_log_history";
