...
public sealed class AgencyBillingPostgresFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _container = new PostgreSqlBuilder("postgres:16")
            .WithDatabase("ngb_agency_billing_tests")
        ...
        await AgencyBillingMigrationSet.ApplyPlatformAndAgencyBillingMigrationsAsync(ConnectionString);
