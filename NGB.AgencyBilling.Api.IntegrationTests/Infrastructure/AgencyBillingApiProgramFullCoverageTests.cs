...
public sealed class AgencyBillingApiProgramEnvironmentCollection
{
    public const string Name = "Agency Billing API Program environment";
}

[Collection(AgencyBillingApiProgramEnvironmentCollection.Name)]
public sealed class AgencyBillingApiProgramFullCoverageTests
{
    [Theory]
