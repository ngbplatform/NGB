...
public sealed class InventoryAdjustmentInventoryOperationalRegisterPostingHandler(
        ...
        foreach (var line in lines)
        {
            ...
            builder.Add(
                ...
                new OperationalRegisterMovement(
                    ...
                    Resources: TradePostingCommon.BuildInventoryMovementResources(line.QuantityDelta)));
        }
    }
}
