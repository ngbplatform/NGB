...
public sealed class CrmPostgresFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        await CrmMigrationSet.ApplyPlatformAndCrmMigrationsAsync(ConnectionString);
